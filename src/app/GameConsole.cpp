...
GameConsoleWindow::GameConsoleWindow()
{
   ...
   iInstanceNumber = 0;
   sNamePrefix = "";
   CreateCEGUIWindow ("console.layout");
   setVisible(false);
   m_bConsole = false;
}

void GameConsoleWindow::CreateCEGUIWindow (const std::string& inputFileName)
{
	...
	CEGUI::WindowManager *pWindowManager = CEGUI::WindowManager::getSingletonPtr();
        ...
        // Note : for CEGUI 0.7
#ifdef CEGUI_07
		CEGUI::FrameWindow* myFrame = static_cast <CEGUI::FrameWindow*> (win_mgr.loadWindowLayout (inputFileName));
...
#else
			ceguiSysPtr_->getDefaultGUIContext ().getRootWindow ()->addChild (m_ConsoleWindow);
#endif
